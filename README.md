...
For further information please refer to the [Generate and Manage New Projects](/FreeKernelJS/generator-freekerneljs/wiki/generate-app) page. 
...
A list of available templates is specified in this page: **[Templates](templates)**

# <a name="getting-started"></a> Getting Started
1. **[Installation](installation)**: first, you will need to install the environment with only 4 easy steps!
2. **[Generate and Manage New Projects](generate-app)**: then you can learn how to generate a new Project, how to configure and manage it. 
